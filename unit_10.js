...
let ar1 = ['over','24', 43, 14, true, false];
function f1() {
...
let ar2 = ['over','24', 43, 14, true, false];
function f2() {
    let out = '';
...
let ar3 = ['over','24', 43, 14, true, false];
function f3() {
...
let ar4 = ['over','24', 43, 14, true, false];
function f4() {
...
let ar6 = ['Denys', 'Diva', 21, 'September',];
function f6() {
...
function f16() {
	...
	out16_even.innerHTML = q_even;
	out16_odd.innerHTML = q_odd;
}
